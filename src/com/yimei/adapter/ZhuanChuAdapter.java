...
public class ZhuanChuAdapter extends BaseAdapter {

	Context context;
	public static List<Map<String, String>> listData;
	// 构造函数
	public ZhuanChuAdapter(Context context, List<Map<String, String>> datas) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			ZhuanChuActivity.addHViews((GeneralCHScrollView) convertView
